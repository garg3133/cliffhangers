...
def object_tracker(frame_video,x_b,y_b,w_b,h_b,tracker_algo = "MDF" ):
    ...
    cv2.putText(frame_video, "Tracking Started", (100, 75), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0), 2)
    y_cen = (y+y+h)/2
...
out = cv2.VideoWriter('output_my.avi',fourcc, 20.0, (frame_width,frame_height))  
...
while(video.isOpened()):
    ...
    if coordinates!=[]:
        frame,y_cen = object_tracker( frame,x1,y1,width,height,tracker_algo = "MDF")
